...
const UUID = process.env.UUID || '66c5a482-edb2-4408-a569-41340d04d838'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'leykion';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'node-hugface';                    // 节点名称
const PORT = process.env.PORT || 17860;                     // http和ws服务端口
